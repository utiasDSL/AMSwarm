...
{  
    ...
    struct probData
    {
        ...
        int num, num_up, num_static_obs, num_drone, num_obs, nvar, id_badge, unify_obs,
            max_iter, mpc_step, kappa, world, batch;
        ...
        float thresold, mean, stdev;

        float best_traj_index;
        ...
        Eigen :: ArrayXXf h_stack_x_drone, h_stack_y_drone, h_stack_z_drone;
        Eigen :: ArrayXXf h_stack_x_obs, h_stack_y_obs, h_stack_z_obs;
        ...
        std :: vector<float> smoothness, arc_length, inter_agent_dist, agent_obs_dist, inter_agent_dist_min, agent_obs_dist_min, gamma;
    ...
    void trajectorySelector(probData &prob_data, int VERBOSE);
}