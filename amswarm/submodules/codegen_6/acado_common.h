...
/** Matrix of size: 4 x 190 (row major format) */
real_t rk_kkk[ 760 ];
...
real_t conAuxVar[ 255 ];

/** Row vector of size: 49 */
real_t conValueIn[ 49 ];

/** Row vector of size: 95 */
real_t conValueOut[ 95 ];
...
/** Matrix of size: 4650 x 8 (row major format) */
real_t E[ 37200 ];
...
/** Matrix of size: 420 x 240 (row major format) */
real_t A[ 100800 ];
