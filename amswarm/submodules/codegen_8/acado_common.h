...
/** Matrix of size: 31 x 43 (row major format)
 * 
...
/** Row vector of size: 263 */
real_t rk_xxx[ 263 ];

/** Matrix of size: 4 x 210 (row major format) */
real_t rk_kkk[ 840 ];
...
/** Column vector of size: 371 */
real_t conAuxVar[ 371 ];

/** Row vector of size: 63 */
real_t conValueIn[ 63 ];

/** Row vector of size: 147 */
real_t conValueOut[ 147 ];
...
/** Matrix of size: 4650 x 10 (row major format) */
real_t E[ 46500 ];
...
/** Matrix of size: 480 x 300 (row major format) */
real_t A[ 144000 ];
